                ...
                <?php include('php/message.php'); ?>
                    ...
                    <section class="hero-section d-flex justify-content-center align-items-center" id="section_1">
                            ...
                            <!-- <div class="custom-block d-lg-flex flex-column justify-content-center align-items-center">
                                ...
                                <h4><strong class="text-white">To know more about the owner</strong></h4>
                                <a class="smoothscroll btn custom-btn custom-btn-italic mt-3">Click</a>
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-lg-10 col-12 mx-auto">
                                <form action="php/code.php" method="post" class="custom-form booking-form" id="bb-booking-form" role="form">
                                    ...
                                    <div class="booking-form-body">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-12">
                                                <input type="tel" class="form-control" name="phone" placeholder="Mobile 010-020-0340"  required="">
                                            </div>
                                        ...
                                        <div class="col-lg-4 col-md-10 col-8 mx-auto">
                                            <button type="submit" name="book" class="form-control">Submit</button>
                                        </div>
                                    </div>
                                </form>
                        </div>
