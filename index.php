                ...
                <div class="col-md-8 ms-sm-auto col-lg-9 p-0">
                    ...
                    <section class="hero-section d-flex justify-content-center align-items-center" id="section_1">
                            ...
                            <div class="custom-block d-lg-flex flex-column justify-content-center align-items-center">
                                ...
                                <h4><strong class="text-white">Hurry Up! To get a good haircut.</strong></h4>

                                <a href="pages-login.php" class="smoothscroll btn custom-btn custom-btn-italic mt-3">Sign in</a>
                            </div>
                    </section>
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-lg-10 col-12 mx-auto">
                                <form action="code.php" method="post" class="custom-form booking-form" id="bb-booking-form" role="form">
                                    ...
                                    <div class="booking-form-body">
                                        ...
                                        <div class="col-lg-4 col-md-10 col-8 mx-auto">
                                            <button type="submit" name="save-customer" class="form-control">Submit</button>
                                        </div>
                                    </div>
                                </form>
                        </div>
