                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-8 col-12">
                                        ...
                                        <form action="php/code.php" method="POST">
                                            <a class="btn custom-btn custom-border-btn custom-btn-bg-white smoothscroll me-2 mb-2"  href="admin-profile.php">Admin Profile</a>
                                ...
                                <form action="php/code.php" method="post" class="custom-form booking-form" id="bb-booking-form" role="form">
                                    ...
                                    <div class="booking-form-body">
                                        ...
                                        <div class="col-lg-4 col-md-10 col-8 mx-auto">
                                            <button type="submit" name="books" class="form-control">Submit</button>
                                        </div>
                                    </div>
                                </form>
                        </div>
